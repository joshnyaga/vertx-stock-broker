package com.joshua.tutorials.vertx_stock_broker.config;
...
public class ConfigLoader {
  ...
  static final List<String> EXPOSED_ENVIRONMENTAL_VARIABLES = List.of(SERVER_PORT,DB_HOST, DB_PORT, DB_DATABASE, DB_USER, DB_PASSWORD);
  public static final String APPLICATION_YML = "application.yml";

  public static Future<BrokerConfig> load(Vertx vertx){
    final var exposedKeys =new JsonArray();
    EXPOSED_ENVIRONMENTAL_VARIABLES.forEach(exposedKeys::add);
